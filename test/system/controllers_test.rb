...
class ControllersTest < ApplicationSystemTestCase
  ...
  test "creating a Controller" do
    ...
    check "Disponibilita" if @controller.disponibilita
    fill_in "Gioco", with: @controller.gioco
    fill_in "Nome", with: @controller.nome
    fill_in "Prezzo", with: @controller.prezzo
