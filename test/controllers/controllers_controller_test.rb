...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { disponibilita: @controller.disponibilita, gioco: @controller.gioco, nome: @controller.nome, prezzo: @controller.prezzo } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { disponibilita: @controller.disponibilita, gioco: @controller.gioco, nome: @controller.nome, prezzo: @controller.prezzo } }
